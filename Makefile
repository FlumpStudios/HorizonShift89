...
# --- Source Files ---
SRCS = $(SRC_DIR)/main.c $(SRC_DIR)/player.c $(SRC_DIR)/enemy.c $(SRC_DIR)/bullet.c $(SRC_DIR)/collision.c $(SRC_DIR)/utils.c $(SRC_DIR)/starfield.c $(SRC_DIR)/script.c $(SRC_DIR)/explosion.c $(wildcard $(RES_DIR)/*.c)
OBJS = $(SRCS:.c=.o)
