...
const WaveConfig wave_scripts[MAX_WAVES] = {
    { .enemy_mask = 0x01, .spawn_rate = 90 },  // Wave 1: Normal only
    ...
    { .enemy_mask = 0x09, .spawn_rate = 70 },  // Wave 5: Normal + Asteroid
    { .enemy_mask = 0x0F, .spawn_rate = 65 },  // Wave 6: All enemy types
    { .enemy_mask = 0x0F, .spawn_rate = 60 },  // Wave 7: All types, faster
    { .enemy_mask = 0x0F, .spawn_rate = 55 },  // Wave 8: All types, faster
    { .enemy_mask = 0x0F, .spawn_rate = 50 },  // Wave 9: All types, faster
    { .enemy_mask = 0x0F, .spawn_rate = 45 }   // Wave 10: All types, fastest
};
